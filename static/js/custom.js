(function ($) {
    ...
    NAY.OnePageTop = function () {
        $('.header-one-page a[href*="#"]:not([href="#"])').on(
            "click",
            function () {
                if (
                    location.pathname.replace(/^\//, "") ==
    ...
    * Masonry
    ...
    NAY.masonry = function () {
        ...
        if ($(".portfolio-content").exists()) {
            loadScript(
                plugin_track + "isotope/isotope.pkgd.min.js",
                function () {
                    if ($(".portfolio-content").exists()) {
    ...
    NAY.particles = function () {
        if ($("#particles-box").exists()) {
            loadScript(
                plugin_track + "particles/particles.min.js",
                function () {}
            );
            loadScript(
                plugin_track + "particles/particles-app.js",
                function () {}
            );
        }
    };
    ...
    NAY.VideoBG = function () {
        if ($(".video-bg").exists()) {
            loadScript(
                plugin_track + "vide/jquery.vide.min.js",
                function () {}
            );
        }
    };
    ...
    NAY.mTypeIt = function () {
        if ($("#type-it").exists()) {
            loadScript(
                plugin_track + "typeit-master/typeit.min.js",
                function () {
                    new TypeIt("#type-it", {
                        speed: 200,
                        loop: true,
    ...
    function loadScript(scriptName, callback) {
        if (!_arr[scriptName]) {
            ...
            script.src = window.location.origin+scriptName;
